...
save(bias_alfa_rq, bias_alfa_conquer, file = "bias_alfa_lsf1.RData") 
save(bias_beta1_rq, bias_beta1_conquer, file = "bias_beta1_lsf1.RData")
save(bias_beta2_rq, bias_beta2_conquer,  file = "bias_beta2_lsf1.RData")

save(rmse_alfa_rq, rmse_alfa_conquer,  file = "rmse_alfa_lsf1.RData")
save(rmse_beta1_rq, rmse_beta1_conquer,  file = "rmse_beta1_lsf1.RData")
save(rmse_beta2_rq, rmse_beta2_conquer, file = "rmse_beta2_lsf1.RData")
